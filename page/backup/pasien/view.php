...
if($cari){
	...
	$start	= ($hal - 1) * $per_hal;
		...
		while($get = mysql_fetch_array($s)) {
				$data .= '	<tr>
							...
							<td class="wow fadeIn" data-wow-delay=".3s">'.$get['tgllahirpas'].'</td>
							<td class="wow fadeIn" data-wow-delay=".3s">'.$get['jeniskelpas'].'</td>
							<td class="wow fadeIn" data-wow-delay=".3s">'.$get['tglregistrasi'].'</td>
							...
							data-content="Edit data dengan no. pasien '.$get['Nopasien'].'"
							...
							data-content="Hapus data dengan no. pasien '.$get['Nopasien'].'"
	...
	$hx		= '	<table class="table table-bordered table-hover"><tr>
				<td class="wow bounceIn" data-wow-delay=".5s" colspan="10" align="center"><h2>'.$a.'</h2></td></tr></table>';
	$dx		= '<tr><td align="center" colspan="10" class="wow bounceIn" data-wow-delay=".5s"><h2>Data Tidak Ditemukan!<h2></td></tr>';
	$herr	= '<tr><td align="center" colspan="10" class="wow bounceIn" data-wow-delay=".5s"><h2>Halaman Tidak Ada!<h2></td></tr>';
