...
if(!defined('MY_APP')) die('No direct access allowed to this page.');
		...
		while($get = mysql_fetch_array($s)) {
				$data .= '	<tr>
							...
							<td class="wow fadeIn" data-wow-delay=".3s">'.FlipDate($get['tgllhrpeg'], 'dmy').'</td>
	...
	$hx		= '	<table class="table table-bordered table-hover"><tr>
				<td colspan="9" align="center"><h2>'.$a.'</h2></td></tr></table>';
	$dx		= '<tr><td align="center" colspan="9"><h2>Data Tidak Ditemukan!<h2></td></tr>';
	$herr	= '<tr><td align="center" colspan="9"><h2>Halaman Tidak Ada!<h2></td></tr>';
