...
if(!defined('MY_APP')) die('No direct access allowed to this page.');
	...
	$hx		= '	<table class="table table-bordered table-hover"><tr>
				<td colspan="5" align="center"><h2>'.$a.'</h2></td></tr></table>';
	$dx		= '<tr><td align="center" colspan="5"><h2>Data Tidak Ditemukan!<h2></td></tr>';
	$herr	= '<tr><td align="center" colspan="5"><h2>Halaman Tidak Ada!<h2></td></tr>';
