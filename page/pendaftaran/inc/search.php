	...
	$search	= '	<table class="table table-bordered"><tr><td align="center">
				...
				<label for="icon_prefix">Pencarian</label><div class="input-field col s12">
					<select name="tipe">
						...
						<option value="Nopasien_pen">No. Pasien</option>
						<option value="idjenisbiaya_pen">ID Jenis Biaya</option>
						<option value="nip_pen">NIP</option>
						<option value="kodejadwal_pen">Kode Jadwal</option>
					</select></div>
