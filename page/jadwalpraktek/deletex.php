...
require_once $inc_dir.'head.php';
		...
		if($delx){
			...
			if($jml > 0){							//jika ada data yang dicentang
					...
					Anda yakin ingin menghapus data dari tabel '.$p.' dengan kode jadwal masing - masing adalah:
					<form method="post">';
					...
					data-trigger="hover" data-content="Batal"><i class="fa fa-times-circle"> Batal</i></a>';
